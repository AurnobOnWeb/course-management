...
@section('title')
All  Teacher Sms  | @foreach($settings as $setting)  {{ $setting->institute_name }}  @endforeach
@endsection
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">All  Teacher Sms  <div class="float-right" style="color:white;">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                           <input class="form-control" type="text" disabled value="All Teacher">
                        </div>
                    </div>
                    <div class="form-group row">
