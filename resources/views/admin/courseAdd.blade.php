...
@section('title')
Course Information Add | @foreach($settings as $setting)  {{ $setting->institute_name }}  @endforeach
@endsection
@section('content')
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <h5 class="card-header">Add Course Information </h5>
            <div class="card-body">
                
                <form id="validationform" action="{{ route('course.store') }}" method="post" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                    @csrf
                ...
                @endif 
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input name="course_name" type="text" required value="{{  old('course_name')}}" placeholder=" Name" class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" id="coursePrice" class="form-control" value="{{  old('course_price')}}" name="course_price"  placeholder="Course Price" required> 
                            <span class="text-danger">
                                @error('course_price')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" id="discount" class="form-control" value="{{  old('discount')}}" name="discount"  placeholder="Course Discount">
                            <span class="text-danger">
                                @error('discount')
                                    {{ $message }}
                                @enderror
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" id="discountedPrice" class="form-control" value="{{  old('discount_price')}}" name="discount_price"  placeholder=" Discount Price">
                            <span class="text-danger">
                    ...
                    <div class="form-group row text-right">
                        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                            <button type="submit" class="btn btn-space btn-primary">Add Course</button>
                        </div>
                    </div>
                </form>
            </div>
